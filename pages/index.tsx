...
export default function Home() {
  ...
  return (  
    <div className="min-h-screen w-full">
      <div className="h-screen py-32 flex flex-col items-center justify-start gap-16 md:gap-8 px-2 md:px-4">
      ...
      <div className="section-container h-screen flex items-center justify-center overflow-hidden">
